...
//Gestión LIFO. Solución basada en mi Implementación con monitores SC para varios productores y consumidores (LIFO),
...
int ProdconsM_SU::leer(){
  ...
  while ( primera_libre == 0 ) //Sustituir if por while
     ocupadas.wait();
